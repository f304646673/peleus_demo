...
using ::peleus_demo::redis::asyn::RedisAsynRequest;
using ::peleus_demo::redis::asyn::RedisAsynResponse;
using ::peleus_demo::redis::asyn::RedisAsynService_Stub;
...
int main(int argc, const char** argv) {
    ...
    ServiceService_Stub stub(static_cast<google::protobuf::RpcChannel*>(&channel));
